...
export var CELL_WIDTH = 340;
export var CELL_HEIGHT = 150;
export var NODE_WIDTH = 240;
export var NODE_HEIGHT = 80;
export function calculateTransitLayout(nodes, edges) {
